...
<html lang="en">
  <head>
    ...
    <title>IT WILL BOOKS - Checkout</title>
    <!-- Fonts-->
  ...
  <script type="text/javascript">
  	function sendIt(){
  		...
  		f.action = "/study/itwillbook/checkout_ok.do";
  		f.submit();
                ...
                <c:set var="sum2" value="0"/>
                 <c:forEach var="dto" items="${ilists}">
                  <div class="ps-cart-item">
                  	<a class="ps-cart-item__close" href="<%=cp %>/itwillbook/deleteItemCheckout.do?name=${dto.name}"></a>
    ...
    <main class="ps-main">
      <div class="ps-checkout pt-80 pb-80">
        <div class="ps-container">
          <form class="ps-checkout__form" action="" method="post" name="myForm">
            <div class="row">
                  <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 ">
                    <div class="ps-checkout__billing">
                      <h3>배송 정보</h3>
                              ...
                              <input class="form-control" type="text" name="userName" value="${mdto.userName }">
                            </div>
                           
                            <div class="form-group form-group--inline">
                              <label>이메일<span>*</span>
                              </label>
                              <input class="form-control" type="email" name="email" value="${mdto.email }">
                            </div>
                          
                            <div class="form-group form-group--inline">
                              <label>전화번호<span>*</span>
                              </label>
                              <input class="form-control" type="text" name="tel" value="${mdto.userTel }">
                            </div>
                            <div class="form-group form-group--inline">
                              <label>배송지 주소<span>*</span>
                              </label>
                      ...
                      <h3 class="mt-40"> 추가 사항</h3>
                      <div class="form-group form-group--inline textarea">
                        <label>배송 메모</label>
                        <textarea class="form-control" name="notes" rows="5" placeholder="택배기사님께 전할 말씀을 남겨주세요."></textarea>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="ps-checkout__order">
                      ...
                      <div class="content">
                        <table class="table ps-checkout__products">
                          <thead>
                            <tr>
                              <th class="text-uppercase">상품 정보</th>
                              <th class="text-uppercase">주문 가격</th>
                            </tr>
                          </thead>
                          <tbody>
                          <c:set var="sum" value="0"/>
                          <c:forEach var="dto" items="${lists }">
                            <tr>
                              <td>${dto.name } x${dto.quantity }</td>
                              <td>${dto.price*dto.quantity}&nbsp;원</td>
                              <c:set var="sum" value="${sum+dto.price*dto.quantity }"/>
                            </tr>
                           </c:forEach>
                           	...
                           	<tr>
	                           	<td>
	                           		<font size="5pt" color="#2ac37d">총 상품 가격</font>
	                       		</td>
	                             <td>
	                             	<font size="5pt" color="#2ac37d"><c:out value="${sum }"/>&nbsp;원</font>
	                             </td>
                             </tr>
                          </tbody>
                        </table>
                      ...
                      <footer>
                        ...
                        <div class="form-group paypal">
                          <div class="ps-radio ps-radio--inline">
                            ...
                            <label for="rdo02">카드 결제</label>
                          </div>
                          <ul class="ps-payment-method">
                            <li><a href="#"><img src="<%=cp%>/book/images/payment/1.png" alt=""></a></li>
                            <li><a href="#"><img src="<%=cp%>/book/images/payment/2.png" alt=""></a></li>
                            <li><a href="#"><img src="<%=cp%>/book/images/payment/3.png" alt=""></a></li>
                          </ul>
                          <button class="ps-btn ps-btn--fullwidth" onclick="sendIt();">결제 하기<i class="ps-icon-next"></i></button>
                        </div>
                      </footer>
                    </div>
