...
<script type="text/javascript">
	...
	function sendIt(){
		...
		f.action = "<%=cp %>/itwillbook/ordersUpdate_ok.do";
          ...
          <footer>
            <form action="javascript:sendIt();" method="post" name="myForm">
              ...
              <div class="form-group">
                <label>주문번호<span>*</span></label><br/>
                ${dto.num }
                <input class="form-control" type="hidden" name="num" value="${dto.num }">
              </div>
              
              <div class="form-group">
                <label>아이디<span>*</span></label><br/>
                ${dto.id }
              </div>
              
              <div class="form-group">
                <label>회원이름<span>*</span></label><br/>
                ${dto.userName }
              </div>
              ...
              <div class="form-group text-center">
                <button class="ps-btn" type="submit">변경<i class="fa fa-angle-right"></i></button>
