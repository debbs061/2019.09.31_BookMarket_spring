...
<script type="text/javascript">
	...
	function login() {
		...
		f.action = "<%=cp%>/itwillbook/login_ok.do";
		f.submit();
          ...
          <footer>
             <form action="" method="post" name="myForm">
              ...
              <div class="form-group text-center">
                <button type="button" 
                class="ps-btn"  onclick="javascript:location.href='<%=cp %>/itwillbook/register.do'">회원가입
                <i class="fa fa-angle-right"></i></button>
              </div>
              <div class="form-group text-center">
                <button type="button" class="ps-btn" onclick="login();">로그인<i class="fa fa-angle-right"></i></button>
              </div>
              <div class="form-group text-center">
                <button type="button"  class="ps-btn" 
                onclick="javascript:location.href='<%=cp%>/itwillbook/searchpw.do';">비밀번호 찾기<i class="fa fa-angle-right"></i></button>
              </div>
            </form>
