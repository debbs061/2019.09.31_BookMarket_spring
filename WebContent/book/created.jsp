...
<script type="text/javascript">
	...
	function sendIt(){
		...
		f.action = "<%=cp %>/itwillbook/created_ok.do";
		<%-- f.action = "<%=cp %>/book/register_ok.jsp"; --%>
		f.submit();
	}
        ...
        <div class="container-fluid">
          <div class="row">
                ...
                <div class="col-lg-6 col-md-4 col-sm-6 col-xs-12 ">
                  <%-- <div class="header__actions"><a href="<%=cp%>/itwillbook/login.do">Login & Register</a>
                  </div> --%>
                </div>
          </div>
        </div>
    ...
    <main class="ps-main">
      <div class="ps-home-contact">
        ...
        <div class="ps-home-contact__form">
          ...
          <footer>
            <form action="javascript:sendIt();" method="post" name="myForm" enctype="multipart/form-data">
              <div class="form-group">
                <label>제목<span>*</span></label>
                <input class="form-control" type="text" name="name">
              </div>
              <div class="form-group">
                <label>작가<span>*</span></label>
                <input class="form-control" type="text" name="writer">
              </div>
              <div class="form-group">
                <label>카테고리<span>*</span></label><br/>
                <!-- <input class="form-control" type="text" name="category"> -->
                <select class="ps-select selectpicker" name="category">
              ...
              <div class="form-group">
                <label>파일<span>*</span></label>
                <input class="form-control" type="file" name="upload">
              </div>
              
              <div class="form-group text-center">
                <button class="ps-btn">등록<i class="fa fa-angle-right"></i></button>
              </div>
            </form>
          </footer>
        </div>
