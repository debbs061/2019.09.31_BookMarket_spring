...
<script type="text/javascript">
	...
	function sendIt(){
		...
		f.action = "<%=cp %>/itwillbook/delete_ok.do";
                  ...
                  <%-- 
                 	 <c:choose>
						<c:when test="${empty sessionScope.customInfo.userId }">
							<a href="<%=cp%>/itwillbook/login.do">Login & Register</a><br/><br/>
						</c:when>
      ...
      <div class="ps-home-contact">
        ...
        <div class="ps-home-contact__form">
          <header>
            ...
            책제목:<input class="form-control" type="text" name="name">
          </header>
         
          <div class="form-group text-center">
            <button class="ps-btn" onclick="sendIt();">삭제<i class="fa fa-angle-right"></i></button>
          </div>
          </form>
        </div>
      </div>
